...
level.addEventListener('input', () => {
    ...
    sam.classList.remove('show')
    sam.classList.add('hide')
    if(level.value == 0) return null
    else if (level.value == 5) secs.classList.add('show'), secs.classList.remove('hide')
        ...
        secs.addEventListener('input', () => {
            if (secs.value == 0) {
                null
            } else if (secs.value == 10) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = arr+boy+cur+dal+fra+lav+men+pau+rut
                sam.value = slovin(arr+boy+cur+dal+fra+lav+men+pau+rut, 0.05)
            } else if (secs.value == 1) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = arr
                sam.value = slovin(arr, 0.05)
            } else if (secs.value == 2) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = boy
                sam.value = slovin(boy, 0.05)
            }  else if (secs.value == 3) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = cur
                sam.value = slovin(cur, 0.05)
            }  else if (secs.value == 4) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = dal
                sam.value = slovin(dal, 0.05)
            }  else if (secs.value == 5) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = fra
                sam.value = slovin(fra, 0.05)
            }  else if (secs.value == 6) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = lav
                sam.value = slovin(lav, 0.05)
            }  else if (secs.value == 7) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = men
                sam.value = slovin(men, 0.05)
            }  else if (secs.value == 8) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = pau
                sam.value = slovin(pau, 0.05)
            }  else if (secs.value == 9) {
                pop.classList.add('show'), 
                pop.classList.remove('hide'),
                sam.classList.add('show'), 
                sam.classList.remove('hide'),
                pop.value = rut
                sam.value = slovin(rut, 0.05)
            }
        })
    })
        ...
        fetch("level-json/g10.json")
            ...
            secs.addEventListener('input', () => {
                if (secs.value == 0) {
                    ...
                    sam.classList.add('show'), 
                    sam.classList.remove('hide'),
                    pop.value = arc+ber+edi+ein+far+max+newt+pas+tho
                    sam.value = slovin(arc+ber+edi+ein+far+max+newt+pas+tho, 0.05)
                } else if (secs.value == 1) {
                    pop.classList.add('show'), 
                    pop.classList.remove('hide'),
                    sam.classList.add('show'), 
